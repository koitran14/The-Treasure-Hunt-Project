...
public class Playing extends State implements Statemethods {
	...
	private void loadDialogue() {
		...
		// This is a simple way of avoiding ConcurrentModificationException error.
	...
	private void loadDialogueImgs() {
		BufferedImage qtemp = LoadSave.GetSpriteAtlas(LoadSave.QUESTION_ATLAS, Constants.FileType.ENTITY);
		questionImgs = new BufferedImage[5];
		for (int i = 0; i < questionImgs.length; i++)
			questionImgs[i] = qtemp.getSubimage(i * 14, 0, 14, 12);

		BufferedImage etemp = LoadSave.GetSpriteAtlas(LoadSave.EXCLAMATION_ATLAS, Constants.FileType.ENTITY);
